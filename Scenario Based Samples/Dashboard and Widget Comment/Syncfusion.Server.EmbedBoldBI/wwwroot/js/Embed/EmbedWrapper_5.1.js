...
class BoldBI {
    ...
    */
    ...
    getDashboardCategories(clientFnc) {
        var dbrdInstance = this._getDashboardInstance();
        if (dbrdInstance != undefined) {
            var catList = dbrdInstance.GetDashboardCategories(clientFnc);
            if (window[clientFnc] instanceof Function) {
                window[clientFnc].call(this, catList);
            } else {
                clientFnc.call(this, catList);
            }
        }
    }

    createDashboardCategory(categoryName, categoryDescription, clientFnc) {
        if (categoryName != '' && !this._isNullOrUndefined(categoryName)) {
            var dbrdInstance = this._getDashboardInstance();
            if (dbrdInstance != undefined) {
                var catList = dbrdInstance.CreateDashboardCategory(categoryName, categoryDescription, clientFnc);
                if (window[clientFnc] instanceof Function) {
                    window[clientFnc].call(this, catList);
                } else {
                    clientFnc.call(this, catList);
    ...
    saveDashboard(dashboardModel) {
        var dbrdInstance = this._getDashboardInstance();
        if (!this._isNullOrUndefined(dbrdInstance)) {
            dbrdInstance.saveDashboardToServer(dashboardModel);
        }
    }
            ...
            if (this.embedOptions.pinboardName !== "" && this.pinboardIds.length === 0) {
                ...
                if (this.embedOptions.mode == BoldBI.Mode.Design) {
                    ...
                    dashboardOptions.designerSettings = {
                        widgetsPanel: {
                            hideDefaultWidgets: this.embedOptions.dashboardSettings.widgetsPanel? this.embedOptions.dashboardSettings.widgetsPanel.hideDefaultWidgets: false,
                            hideExistingWidgets: this.embedOptions.dashboardSettings.widgetsPanel ? this.embedOptions.dashboardSettings.widgetsPanel.hideExistingWidgets : false,
                            defaultPanelDisplayText: this.embedOptions.dashboardSettings.widgetsPanel ? this.embedOptions.dashboardSettings.widgetsPanel.defaultPanelDisplayText : false,
                            existingPanelDisplayText: this.embedOptions.dashboardSettings.widgetsPanel ? this.embedOptions.dashboardSettings.widgetsPanel.existingPanelDisplayText : false,
                            dragAndDropSettings: {
                                rowSpan: (this.embedOptions.dashboardSettings.widgetsPanel)&&(this.embedOptions.dashboardSettings.widgetsPanel.dragAndDropSettings)? this.embedOptions.dashboardSettings.widgetsPanel.dragAndDropSettings.rowSpan: null,
                                columnSpan: (this.embedOptions.dashboardSettings.widgetsPanel) && (this.embedOptions.dashboardSettings.widgetsPanel.dragAndDropSettings) ? this.embedOptions.dashboardSettings.widgetsPanel.dragAndDropSettings.columnSpan:null,
                                isWidgetMode: (this.embedOptions.dashboardSettings.widgetsPanel) && (this.embedOptions.dashboardSettings.widgetsPanel.dragAndDropSettings) ? this.embedOptions.dashboardSettings.widgetsPanel.dragAndDropSettings.isWidgetMode:false,
                            }

                        },
                        dataSourceConfig: {
                            hideDataSourceConfig: this.embedOptions.dashboardSettings.dataSourceConfig ? this.embedOptions.dashboardSettings.dataSourceConfig.hideDataSourceConfig : false
                        }
                    };

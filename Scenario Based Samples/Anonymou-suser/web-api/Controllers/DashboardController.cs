...
namespace boldbi.web.api.Controllers
{
    ...
    public class DashboardController : ControllerBase
    {
        ...
        public string AuthorizeDashboard([FromBody] object embedQuerString)
        {
            ...
            {
                embedQuery += "&embed_anonymous_token=true&embed_authorize_group=" + anonymousGroupName + "&embed_custom_attribute=[{" + customAttribute + "}]" + "&embed_datasource_filter=[{" + filterParameter + "}]";
            }

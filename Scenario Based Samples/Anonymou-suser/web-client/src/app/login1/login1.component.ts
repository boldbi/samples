...
export class LoginComponent1 implements OnInit {
  ...
  //         let existingWrapper = dropdownDiv.querySelector('.dropdown-info-wrapper');
  // if (!existingWrapper) {
  //   let wrapper = document.createElement('div');
  //   wrapper.className = 'dropdown-info-wrapper';
  ...
  //   tooltip.id = 'dropdown-infoTooltip';
  //   tooltip.className = 'dropdown-info-content';
  //   tooltip.innerHTML = `
  //     <table class="table table-bordered" style="margin-bottom: 0px">
  //       <tr><th>Tenant</th><td>Alpha Electronics</td></tr>
  //       <tr><th>Username</th><td>Grace</td></tr>
  //       <tr><th>User Email</th><td>grace@alphaelectronics.com</td></tr>
  //     </table>`;

  //   wrapper.appendChild(infoIcon);
  //   wrapper.appendChild(tooltip);

  //   clearIcon.insertAdjacentElement('afterend', wrapper);
